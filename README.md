...
22. [l4d2_no_si_fall_stagger_cancel](/Plugin/l4d2_no_si_fall_stagger_cancel/)  
    특수좀비가 낙하로 스태거를 취소하지 못하도록 착지 시 다시 스태거를 겁니다.

23. [l4d2_no_deathfall_cam](/Plugin/l4d2_no_deathfall_cam/)  
    추락 시 카메라 시점 전환을 차단합니다.

24. [l4d2_player_connect_notifier](/Plugin/l4d2_player_connect_notifier/)  
    플레이어가 서버에 접속하면 채팅창에 알립니다.

25. [l4d2_priority_sounds](/Plugin/l4d2_priority_sounds/)  
    중단되지 않는 우선순위 사운드를 설정합니다.

26. [l4d2_quick_healing](/Plugin/l4d2_quick_healing/)  
    시작 은신처 내에서 1회 한정 킷을 즉시 사용할 수 있습니다.

27. [l4d2_ragdoll_remover](/Plugin/l4d2_ragdoll_remover/)  
    CI/SI의 ragdoll을 즉시 제거합니다.

28. [l4d2_rainy_server_assistant](/Plugin/l4d2_rainy_server_assistant/)  
    Rainy 서버 자동화 플러그인

29. [l4d2_reserve_ammo_multiplier](/Plugin/l4d2_reserve_ammo_multiplier/)  
    예비 탄약 소지량을 배율로 조정합니다.

30. [l4d2_round_restart_delay](/Plugin/l4d2_round_restart_delay/)  
    라운드 재시작 지연 시간을 조정합니다.

31. [l4d2_skip_outtro](/Plugin/l4d2_skip_outtro/)  
    맵 클리어 시 아웃트로를 빠르게 건너뜁니다.

32. [l4d2_smoker_antic_fix](/Plugin/l4d2_smoker_antic_fix/)  

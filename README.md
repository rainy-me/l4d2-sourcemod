...
5. [l4d2_fast_map_transition](/Plugin/l4d2_fast_map_transition/)  
   다음 챕터로 넘어가는 데 걸리는 시간을 줄여줍니다.

6. [l4d2_fix_si_sound](/Plugin/l4d2_fix_si_sound/)  
   특수좀비의 무음 문제를 개선합니다.

7. [l4d2_getup_damage_fix](/Plugin/l4d2_getup_damage_fix/)  
   일어나는 애니메이션이 진행되는 동안의 무적타임 불일치 문제를 고칩니다.

8. [l4d2_hang_fall_death_defib_fix](/Plugin/l4d2_hang_fall_death_defib_fix/)  
   매달리는 중에 떨어져 사망한 생존자의 소생 불가 버그를 고칩니다.

9. [l4d2_hide_idle_message](/Plugin/l4d2_hide_idle_message/)  
   유휴 상태 메시지를 채팅창에 표시하지 않도록 합니다.

10. [l4d2_idle_adrenaline_fix](/Plugin/l4d2_idle_adrenaline_fix/)  
    플레이어가 유휴 모드에서 복귀할 때 아드레날린 효과를 유지하도록 합니다.

11. [l4d2_idle_fix](/Plugin/l4d2_idle_fix)  
    유휴 명령 미인식 문제를 해결합니다.

12. [l4d2_idle_flashlight_fix](/Plugin/l4d2_idle_flashlight_fix/)  
    유휴 전 손전등 on/off 상태를 유휴 후에도 유지합니다.

13. [l4d2_idle_reload_on_all_weapons](/Plugin/l4d2_idle_reload_on_all_weapons/)  
    모든 무기에서 유휴 장전이 가능하도록 합니다.

14. [l4d2_item_thrower](/Plugin/l4d2_item_thrower/)  
    들고 있는 무기/아이템을 앞으로 던집니다.

15. [l4d2_no_ci_melee_kill_collision](/Plugin/l4d2_no_ci_melee_kill_collision/)  
    근접무기로 죽인 일반좀비와의 충돌을 제거합니다.

16. [l4d2_no_close_ff](/Plugin/l4d2_no_close_ff/)  
    팀원이 너무 가까이 있을 때 팀킬을 차단합니다.

17. [l4d2_no_deathfall_cam](/Plugin/l4d2_no_deathfall_cam/)  
...
20. [l4d2_ragdoll_remover](/Plugin/l4d2_ragdoll_remover/)  
    CI/SI의 ragdoll을 즉시 제거합니다.

21. [l4d2_rainy_server_assistant](/Plugin/l4d2_rainy_server_assistant/)  
    Rainy 서버 자동화 플러그인

22. [l4d2_reserve_ammo_multiplier](/Plugin/l4d2_reserve_ammo_multiplier/)  
    예비 탄약 소지량을 배율로 조정합니다.

23. [l4d2_skip_outtro](/Plugin/l4d2_skip_outtro/)  
    맵 클리어 시 아웃트로를 빠르게 건너뜁니다.

24. [l4d2_suicide](/Plugin/l4d2_suicide/)  
    어드민 권한 없이 !kill 또는 /kill 명령을 사용할 수 있도록 합니다.

25. [l4d2_tank_props_glow](/Plugin/l4d2_tank_props_glow/)  
    탱크가 날릴 수 있는 물체에 글로우 효과를 줍니다.

26. [l4d2_tank_witch_spawn_notifier](/Plugin/l4d2_tank_witch_spawn_notifier/)  
    탱크 및 윗치의 스폰을 알립니다.

27. [l4d2_tickrate_door_fix](/Plugin/l4d2_tickrate_door_fix/)  
...
7. [l4d2_smoker_instant_grab_fix](/Archive/l4d2_smoker_instant_grab_fix/)  

...
18. [l4d2_no_close_ff](/Plugin/l4d2_no_close_ff/)  
    팀원이 너무 가까이 있을 때 팀킬을 차단합니다.

19. [l4d2_no_deathfall_cam](/Plugin/l4d2_no_deathfall_cam/)  
    추락 시 카메라 시점 전환을 차단합니다.

20. [l4d2_one_punch_shove](/Archive/l4d2_one_punch_shove/)  
    CI, SI를 밀치기 한 번으로 죽일 수 있습니다.

21. [l4d2_player_connect_notifier](/Plugin/l4d2_player_connect_notifier/)  
    플레이어가 서버에 접속하면 채팅창에 알립니다.

22. [l4d2_print_entity_info](/Archive/l4d2_print_entity_info/)  
    크로스헤어가 가리키는 엔티티의 상세 정보를 출력합니다.

23. [l4d2_quick_healing](/Plugin/l4d2_quick_healing/)  
    시작 은신처 내에서 1회 한정 킷을 즉시 사용할 수 있습니다.

24. [l4d2_ragdoll_vanish](/Plugin/l4d2_ragdoll_vanish/)  
    CI/SI의 ragdoll을 즉시 제거합니다.

25. [l4d2_reserve_ammo_multiplier](/Plugin/l4d2_reserve_ammo_multiplier/)  
    예비 탄약 소지량을 배율로 조정합니다.

26. [l4d2_skip_outtro](/Plugin/l4d2_skip_outtro/)  
    맵 클리어 시 아웃트로를 빠르게 건너뜁니다.

27. [l4d2_smoker_instant_grab_fix](/Plugin/l4d2_smoker_instant_grab_fix/)  
    스모커가 worldspawn이 아닌 엔티티 위에 서 있는 생존자를 잡을 때 즉시 끌려가는 버그를 고칩니다.

28. [l4d2_tank_props_glow](/Plugin/l4d2_tank_props_glow/)  
    탱크가 날릴 수 있는 물체에 글로우 효과를 줍니다.

29. [l4d2_tank_witch_spawn_notifier](/Plugin/l4d2_tank_witch_spawn_notifier/)  
    탱크 및 윗치의 스폰을 알립니다.

30. [l4d2_tickrate_door_fix](/Plugin/l4d2_tickrate_door_fix/)  
    틱레이트 변경에 따른 문 속도 문제를 고칩니다.

31. [l4d2_welcome](/Plugin/l4d2_welcome/)  
    환영 인사와 서버 안내를 합니다.

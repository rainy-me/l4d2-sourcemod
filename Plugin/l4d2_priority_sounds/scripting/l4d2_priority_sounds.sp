...
#define DATA_FILE             "data/l4d2_priority_sounds.txt"
...
{
    name        = "L4D2 Priority Sounds",
    author      = "Rainy",
    description = "중단되지 않는 우선순위 사운드를 설정합니다.",
    version     = "1.0.0",
    url         = "https://github.com/rainy-me/l4d2-sourcemod/tree/main/Plugin/l4d2_priority_sounds"
};
